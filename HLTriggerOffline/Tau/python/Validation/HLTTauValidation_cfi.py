...
hltTauValIdealMonitorMC = cms.EDAnalyzer("HLTTauDQMOfflineSource",
    ...
    DQMBaseFolder = cms.untracked.string("HLT/TAU/TauRelVal/MC"),
...
hltTauValIdealMonitorPF = hltTauValIdealMonitorMC.clone(
    DQMBaseFolder = cms.untracked.string("HLT/TAU/TauRelVal/PF"),
    Matching = cms.PSet(
        doMatching            = cms.untracked.bool(True),
        matchFilters          = cms.untracked.VPSet(
                                    cms.untracked.PSet(
...
hltTauValTagAndProbe = hltTauValIdealMonitorMC.clone(
    DQMBaseFolder = cms.untracked.string("HLT/TAU/TauRelVal/TagAndProbe"),
    Matching = cms.PSet(
        doMatching            = cms.untracked.bool(True),
        matchFilters          = cms.untracked.VPSet(   
                                    cms.untracked.PSet(
